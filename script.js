...
class Apple {
  constructor() {
    ...
    this.score = round(random(1,3))
    console.log(this.score)
  }

  showSelf() {
    stroke(0,0,0)
    if(this.score == 1 ){stroke(80,80,80)}
    if(this.score == 2 ){stroke(160,80,80)}
    if(this.score == 3 ){stroke(240, 100, 100)}
